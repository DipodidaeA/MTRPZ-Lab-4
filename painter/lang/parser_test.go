...
func TestParser(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{numt: "2", cmd: "Rred 0.25 0.25 0.75 0.75\nRgreen 0.5 0.5 0.6 0.6\nupdate", cord: []painter.Cord{{X1: 0.25, Y1: 0.25, X2: 0.75, Y2: 0.75}, {X1: 0.5, Y1: 0.5, X2: 0.6, Y2: 0.6}, {X1: 0, Y1: 0, X2: 0, Y2: 0}}},
	} {
